...
ActiveRecord::Schema[8.1].define(version: 2026_05_08_224500) do
  ...
  create_table "family_connections", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["parent_id", "student_id"], name: "index_family_connections_on_parent_id_and_student_id", unique: true
    t.index ["parent_id"], name: "index_family_connections_on_parent_id"
  ...
  add_foreign_key "family_connections", "users", column: "parent_id"
